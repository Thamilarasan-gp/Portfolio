...
const FlowerIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="1.8em" height="1.8em">
    ...
    <g fill="url(#gradient-flower-fixed)" transform="matrix(.5 0 0 .5 0 .026)">
      ...
      <path d="M18.329 27.677a16.938 16.938 0 0 0 8.271 8.092 11.457 11.457 0 0 0 8.09.3 3.033 3.033 0 0 0 1.709-1.81 11.924 11.924 0 0 0-2.271-11.2c-4.859-5.9-11.576-7.67-19.237-8.523a32.466 32.466 0 0 0 3.438 13.141z" opacity="0.65"></path>
...
const Skills = () => {
  return (
    <div className="w-full flex flex-col md:flex-row items-center justify-center font-sans p-4 sm:p-8 overflow-hidden gap-8">
      {/* Global styles */}
      <style>
        {`
          @keyframes float {
